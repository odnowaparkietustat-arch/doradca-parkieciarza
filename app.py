...
if st.button("GENERUJ PROTOKÓŁ OGLĘDZIN", type="primary", use_container_width=True):
    if moisture is None: st.error("Proszę podać wilgotność podłoża!")
        ...
        full_report = f"Podłoże pod okładzinę ({flooring_type}) stanowi {substrate}{age_info}.{heat_info_full}{curing_info_full} {dil_info} {klaw_info} {pek_info} {lev_info}"
        ...
        # REGUŁA: Zalecam Wykonanie bariery przeciwwilgociowej (NOWA)
        ...
        # Gruntowanie i Masa (Reguła doboru)
